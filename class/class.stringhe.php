...
class Stringhe {
	...
	$stringa = str_replace("Ë", "e", $stringa);
	$stringa = str_replace("È", "e", $stringa);
	$stringa = str_replace("Ï", "i", $stringa);
	$stringa = str_replace("Ú", "o", $stringa);
            ...
            */
               ...
               */
               ...
               if ($total_length+$content_length> $length) {
                   ...
                   // search for html entities (l'entities conta come un carattere, ma nell'html ne uccupa di pi√π, quindi dobbiamo fare in modo di includere completament l'entities, cio√® il suo codice e contarlo interamente come un singolo carattere: scaliamo uno da $left ed aggiungiamo $entities_length all alunghezza della substring)
